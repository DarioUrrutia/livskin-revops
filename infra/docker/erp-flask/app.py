...
from routes.api_internal_lock import bp as api_internal_lock_bp
from routes.api_internal_lock import register_public_endpoints as _register_lock_public
...
def create_app() -> Flask:
    ...
    flask_app.register_blueprint(api_internal_lock_bp)  # Sprint 1.3 — distributed locks via Redis
    ...
    _register_lock_public()  # Sprint 1.3 — endpoints /api/internal/lock/*
